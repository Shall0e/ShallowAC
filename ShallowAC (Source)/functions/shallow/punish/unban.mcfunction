...
execute @a[tag=unban] ~ ~ ~ tag @a[tag=unban] remove softfive
execute @a[tag=unban] ~ ~ ~ tag @a[tag=unban] remove softten
execute @a[tag=unban] ~ ~ ~ tag @a[tag=unban] remove softtwen
execute @a[tag=unban] ~ ~ ~ tag @a[tag=unban] remove softthir
execute @a[tag=unban] ~ ~ ~ tag @a[tag=unban] remove softhour
