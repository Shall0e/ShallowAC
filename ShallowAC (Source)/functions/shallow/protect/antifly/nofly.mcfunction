...
execute @a[scores={nofly=18}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"⟫ §eShallowAC Anti-Fly:§c You have been §4detected§6 in the air§c, you will be §6pulled§c to the ground."}]}
execute @a[scores={nofly=18}] ~ ~ ~ playsound damage.fallsmall @s
execute @a[scores={nofly=20}] ~ ~ ~ tp @s ~ ~-1 ~
execute @a[scores={nofly=20}] ~ ~ ~ scoreboard players set @s nofly 19
